 ...
 */
public class Email {
    static final String REMETENTE_NOME = "canalmarotoviagens@gmail.com";
    static final String REMETENTE_SENHA = "Aq960714";
     ...
     */
    public void enviar (){
        SimpleEmail email = new SimpleEmail();      // simploemail vem da biblioteca importada
